...
The DHT11 sensor allows us to measure both temperature and humidity. It consists of an 8-bit microcontroller and two sensors tucked into a tiny blue plastic box.
...
Another interesting asset that is about to be specified is the passive infrared motion sensor. In a nutshell, it can detect movement of objects that radiate infrared light, like humans. Because of this, it's a sensor relatively common in security systems and it could really have a lot of applications in farming, specially if we are trying to detect intruders.

Some other applications, less related to security, might include automatically switching ON and OFF several devices. See for example turning on a light when movement is detected, so the farmer or worker can forget about lighting and just focus in the main task.
